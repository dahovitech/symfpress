        ...
        $builder
            ...
            ->add('status', ChoiceType::class, [
                ...
                'choices' => [
                    ...
                    'Programmé' => Post::STATUS_SCHEDULED,
                    'Privé' => Post::STATUS_PRIVATE,
                    'Corbeille' => Post::STATUS_TRASH,
                ],
                'attr' => [
                    'class' => 'form-select'
                ]
            ...
            ->add('categories', EntityType::class, [
                ...
                'choice_label' => function (Category $category) use ($currentLanguage) {
                    $translation = $category->getTranslationForLanguage($currentLanguage);
                    return $translation ? $translation->getName() : 'Catégorie #' . $category->getId();
                },
                'multiple' => true,
                'expanded' => true,
                'required' => false,
            ...
            ->add('tags', EntityType::class, [
                'label' => 'Tags',
                'class' => Tag::class,
                'choice_label' => function (Tag $tag) use ($currentLanguage) {
                    $translation = $tag->getTranslationForLanguage($currentLanguage);
                    return $translation ? $translation->getName() : 'Tag #' . $tag->getId();
                },
                'multiple' => true,
                'expanded' => false,
                'required' => false,
