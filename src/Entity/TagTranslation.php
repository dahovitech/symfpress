...
#[ORM\UniqueConstraint(name: 'tag_language_unique', columns: ['tag_id', 'language_id'])]
class TagTranslation
{
    ...
    #[ORM\ManyToOne(targetEntity: Language::class, inversedBy: 'tagTranslations')]
    #[ORM\JoinColumn(nullable: false)]
    ...
    {
        return sprintf('%s (%s)', $this->name ?? '', $this->language?->getCode() ?? '');
    }
}